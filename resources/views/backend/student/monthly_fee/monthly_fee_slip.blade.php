...
<body>
@php
  $registrationfee = App\Models\FeeCategoryAmount::where('fee_category_id','2')->where('class_id',$item->class_id)->first();
...
<table id="customers">
  <tr>
    ...
    <td>
      ...
      <p>Student Monthly Fee For <span style="color: red">{{ $month }}</span> Month.</p>
    </td>
  </tr>
</table>
...
<table id="customers">
  ...
  <tr>
    <td>9</td>
    <td><b>Fee For <span style="color: red">{{ $month }}</span> Month.</b></td>
    <td>{{ $finalfee}}$</td>
  </tr>
</table>
<br>
