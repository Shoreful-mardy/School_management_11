...
<head>
  <meta charset="utf-8">
    ...
    <title>Easy Admin - Recover Password</title>
                            ...
                            <form action="{{ route('password.email') }}" method="post">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" id="email" name="email"  class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Your Email" value="{{ old('email') }}">
                                        @error('email')
